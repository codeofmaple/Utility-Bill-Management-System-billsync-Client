...
const Navbar = () => {
    ...
    const Links = ({ isMobile = false }) => (
        <>
            ...
            {user && <NavLink to="/my-bills" className={linkClass} onClick={closeMobile}><FiCreditCard /> My Bills</NavLink>}
            ...
            <div className="bg-linear-to-r from-cyan-400/5 to-purple-500/5">
                <div className="navbar bill-sync-container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16">
                    <div className="navbar-start">
                        <Link to="/" className="flex items-center space-x-3 hover:opacity-90 transition-all duration-300" aria-label="BillSync Home">
