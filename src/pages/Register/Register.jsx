...
const Register = () => {
    ...
    return (
        <Fade triggerOnce duration={1000}>
            <div className="min-h-screen flex items-center justify-center px-4 py-5" style={{ background: 'linear-gradient(135deg,#06202f 0%, #08122a 50%, #2b0b3a 100%)' }}>
                        ...
                        <div className="relative z-10 rounded-2xl backdrop-blur-md bg-linear-to-br from-white/6 via-white/4 to-white/3 border border-white/10 shadow-2xl p-8 transform transition-all duration-500 hover:shadow-3xl">
                            ...
                            <Fade triggerOnce cascade damping={0.3}>
                                <div className="text-center mb-6 relative z-20">
                                    <Zoom triggerOnce duration={600}>
                                        <div className="inline-block hover:scale-110 transition-transform duration-300 mb-1">
                            ...
                            {error && (
                                <Fade triggerOnce duration={400}>
                                    <div className="mb-4 p-3 rounded-lg bg-red-500/10 border border-red-500/20 text-red-300 text-sm relative z-20 transform transition-all duration-300">
                                        {error}
                                    </div>
                                </Fade>
                            )}
                                ...
                                <Fade triggerOnce cascade damping={0.2} delay={200}>
                                    <div className="space-y-4">
                                        <div className="relative transform transition-all duration-300 hover:scale-[1.02]">
                                            <FiUser className="absolute left-4 top-3.5 text-white/60 transition-colors duration-300" />
                                            <input type="text" name="name" placeholder="Full Name" className={`${inputBase} pl-12 focus:border-cyan-400 focus:shadow-lg focus:shadow-cyan-500/20`} required />
                                        </div>

                                        <div className="relative transform transition-all duration-300 hover:scale-[1.02]">
                                            <FiMail className="absolute left-4 top-3.5 text-white/60 transition-colors duration-300" />
                                            <input type="email" name="email" placeholder="Email address" className={`${inputBase} pl-12 focus:border-cyan-400 focus:shadow-lg focus:shadow-cyan-500/20`} required />
                                        </div>

                                        <div className="relative transform transition-all duration-300 hover:scale-[1.02]">
                                            <FiCamera className="absolute left-4 top-3.5 text-white/60 transition-colors duration-300" />
                                            <input type="url" name="photoURL" placeholder="Profile Photo URL" className={`${inputBase} pl-12 focus:border-cyan-400 focus:shadow-lg focus:shadow-cyan-500/20`} required />
                                        </div>
                            ...
                            <Fade triggerOnce delay={900}>
                                <p className="text-center mt-5 text-sm text-white/70 relative z-20">
                                    ...
                                    <NavLink to="/login" className="font-semibold text-transparent bg-linear-to-r from-cyan-300 to-purple-300 bg-clip-text hover:underline transition-all duration-300">
                                        Login Now
                                    </NavLink>
                                </p>
                            </Fade>
